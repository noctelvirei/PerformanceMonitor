export function createBrowserServices(toastRegion) {
  return {
    ...
    handleHealthNotifications(servers, loadedOnce) {
      const priorSnapshot = JSON.parse(localStorage.getItem("pm-central-repository-health") || "{}");
      const nextSnapshot = {};
      ...
      localStorage.setItem("pm-central-repository-health", JSON.stringify(nextSnapshot));
    }
  };
}
